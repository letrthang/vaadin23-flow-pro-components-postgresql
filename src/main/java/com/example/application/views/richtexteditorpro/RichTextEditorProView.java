package com.example.application.views.richtexteditorpro;
...
@PageTitle("Rich Text Editor Pro")
@Route(value = "rich-text-editor-pro")
public class RichTextEditorProView extends Main {

    public RichTextEditorProView() {
    ...
    private Section createSidebar() {
        ...
        sidebar.addClassNames("bg-contrast-5", "box-border", "flex", "flex-col", "flex-shrink-0", "overflow-auto",
                "p-l");
