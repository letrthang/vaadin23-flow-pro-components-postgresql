package com.example.application.views.masterdetaildesigner;
...
@PageTitle("Master Detail Designer")
@Route(value = "master-detail-designer/:samplePersonID?/:action?(edit)")
@Tag("master-detail-designer-view")
@JsModule("./views/masterdetaildesigner/master-detail-designer-view.ts")
@Uses(Icon.class)
public class MasterDetailDesignerView extends LitTemplate implements HasStyle, BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "master-detail-designer/%s/edit";
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(MasterDetailDesignerView.class);
            }
        }
    }
