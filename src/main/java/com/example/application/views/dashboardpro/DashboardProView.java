package com.example.application.views.dashboardpro;


import com.example.application.views.dashboardpro.ServiceHealth.Status;
...
@PageTitle("Dashboard Pro")
@Route(value = "dashboard-pro")
public class DashboardProView extends Main {

    public DashboardProView() {
        addClassName("dashboard-pro-view");
